...
>
	...
	>
		...
		<!-- Model Run Selection Dropdown — removed. R2 (via our proxy) is the
		     single source of truth for which run is served, so users can't
		     (and don't need to) pick older runs. -->
